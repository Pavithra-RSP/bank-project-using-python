...
def home():
    ...
    label_wel=tk.Label(root,text="PAVI  BANK",fg="lime",font=("times new roman",40))
    ...
    x=tk.Label(frame,text=" © CopyRight 2024 PAVI",font=f)
...
def login():
    ...
    label_wel=tk.Label(par1,text="PAVI  BANK",fg="lime",font=("times new roman",20))
    label_wel.configure(bg="darkolivegreen4")
    label_wel.pack(pady=20)
    ...
    y=tk.Label(fram,text=" © CopyRight 2024 PAVI",font=f)
    #bg="yellow",fg="black")
...
def register():
    ...
    x=tk.Label(frame,text=" © CopyRight 2024 PAVII",font=f)
    x.configure(bg="yellow",fg="black")
    x.place(relx=.40,rely=0.94)'''
